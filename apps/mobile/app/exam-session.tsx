  ...
  const nextQ = () => {
    ...
    if (currentIdx + 1 >= questions.length) {
      ...
      qc.setQueryData<ExamSession | undefined>(
        ...
        (old) =>
          old
            ? { ...old, current_question_index: currentIdx + 1 }
            : old,
      );
    }
  };
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      >
        <View>
          ...
          <Text style={[type.labelSm, { color: theme.textMuted, marginTop: 4 }]}>
        ...
        <View style={{ alignItems: "flex-end" }}>
          ...
          >
            <Text style={{ color: theme.red, fontSize: 12, letterSpacing: 0.4, marginTop: 4 }}>
              ABANDON
            </Text>
          </Pressable>
        </View>
      ...
      <ProgressBar
        value={questions.length ? (currentIdx + (picked[current?.id ?? ""] ? 1 : 0)) / questions.length : 0}
        height={2}
        tint={theme.accent}
      />
        ...
        {current ? (
          <View style={{ gap: 20 }}>
            <View style={{ gap: 8 }}>
              ...
              <Text style={[type.h3, { color: theme.text }]}>{current.prompt}</Text>
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      backgroundColor: sel ? `${theme.accent}0A` : "transparent",
                    }}
                  >
                    <Text
                      style={{
