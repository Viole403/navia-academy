  ...
  return (
    <div className="animate-fade-up">
        ...
        tabs={[
          ...
          },
          {
            ...
            label: t("tasks.tabOverdue", {
              count: String(
                enriched.filter((task) => task.status === "overdue").length
              ),
            }),
          },
      ...
      <TabPanel baseId="tasks-tabs" tabId={tab}>
        {filtered.length === 0 ? (
          <EmptyState
            ...
            title={
              tab === "done" ? t("tasks.emptyDone") : t("tasks.emptyNothing")
            }
            description={
              tab === "overdue" ? t("tasks.emptyOverdue") : t("tasks.emptyDesc")
            }
            action={
              ...
              <Card key={task.id} className="flex items-center gap-3.5 p-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-1.5 text-xs">
                    <Badge
                      tone={task.status === "overdue" ? "danger" : "neutral"}
                    >
                ...
                <div className="flex shrink-0 items-center gap-1">
                  ...
                  <button
                    ...
                    className="cursor-pointer rounded-lg p-2 text-ink-faint hover:bg-hover hover:text-danger"
                  >
      ...
      <CreateTaskModal
        ...
        onCreate={(task) => progress.addTask({ ...task, language: lang })}
      />
    </div>
  )
}
