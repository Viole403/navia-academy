...
export default function NotFound() {
  ...
  const ctaLabel = user?.role === "admin" ? t("notFound.admin") : user?.role === "contributor" || user?.role === "reviewer" ? t("notFound.contributor") : t("nav.dashboard");
  ...
  return (
    <main className="paper-texture flex min-h-screen flex-col items-center justify-center bg-bg px-4 text-center">
      ...
      <h1 className="font-display mt-6 text-4xl font-bold">404 · {t("error.notFound")}</h1>
