    ...
    <>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0" aria-hidden>
          <div className="absolute top-[-20%] left-[-12%] h-[28rem] w-[28rem] rounded-full bg-[var(--bauhaus-red)]/20 blur-3xl" />
          <div className="absolute top-[10%] right-[-10%] h-[26rem] w-[26rem] rounded-full bg-[var(--bauhaus-blue)]/20 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-16 pb-16 sm:px-6 md:pt-24 md:pb-24">
          <Reveal>
            ...
            {MODULES.map(({ key, icon: Icon }, i) => (
              <Reveal key={key} delay={(i % 4) * 0.06}>
                <Float3D className="h-full" tilt={7}>
                  <div className="group shadow-neo h-full scroll-mt-28 border border-line bg-sunken">
                    <div className="border-b border-line p-6">
                      <span
                        className={cn(
                          "bauhaus-chip inline-flex",
      ...
      <section className="border-t border-line bg-sunken">
        <div className="mx-auto max-w-6xl px-4 py-16 text-center sm:px-6 md:py-20">
          <Reveal>
            <h2 className="text-display-lg font-display tracking-tight text-ink">
              {t("cta.title")}
            </h2>
