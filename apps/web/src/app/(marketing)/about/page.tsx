    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-6 md:pb-28 md:pt-24">
        <Reveal>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-ink-soft">{t("about.subtitle")}</p>
        </Reveal>

        <div className="mt-12 grid gap-5 md:grid-cols-2" style={{ perspective: 1000 }}>
          <Reveal>
            <Float3D className="h-full" tilt={7}>
              <div className="h-full border border-line bg-sunken shadow-neo">
                <div className="border-b border-line p-6">
                  <span className="bauhaus-chip bauhaus-chip-yellow inline-flex">
                    <HeartHandshake className="h-4 w-4" />
                  </span>
                  <h2 className="font-display mt-5 text-xl font-semibold tracking-tight text-ink">{t("about.mission")}</h2>
                </div>
                <p className="p-6 pt-4 text-sm leading-relaxed text-ink-soft">{t("about.missionText")}</p>
              </div>
            </Float3D>
          </Reveal>
            ...
            <Float3D className="h-full" tilt={7}>
              <div className="h-full border border-line bg-sunken shadow-neo">
                <div className="border-b border-line p-6">
                  ...
                  <h2 className="font-display mt-5 text-xl font-semibold tracking-tight text-ink">{t("about.tech")}</h2>
                </div>
                <p className="p-6 pt-4 text-sm leading-relaxed text-ink-soft">{t("about.techText")}</p>
              </div>
            </Float3D>
          </Reveal>
          ...
          <Reveal>
            <Float3D className="h-full" tilt={7}>
              <div className="h-full border border-line bg-sunken shadow-neo">
                ...
                <p className="p-6 pt-4 text-sm leading-relaxed text-ink-soft">{t("about.contributorsText")}</p>
            ...
            <Float3D className="h-full" tilt={7}>
              <div className="h-full border border-line bg-sunken shadow-neo">
                <div className="border-b border-line p-6">
                  ...
                  <h2 className="font-display mt-5 text-xl font-semibold tracking-tight text-ink">{t("about.support")}</h2>
                </div>
                <p className="p-6 pt-4 text-sm leading-relaxed text-ink-soft">{t("about.supportText")}</p>
                <div className="flex px-6 pb-6">
                  <Link
                    href="/support"
