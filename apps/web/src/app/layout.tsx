...
export const metadata: Metadata = {
  ...
  keywords: ["learn languages", "language academy", "HSK", "TOCFL", "JLPT", "TOEFL", "CEFR", "spaced repetition"],
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: "Navia",
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" data-theme="bauhaus" data-fontsize="md" suppressHydrationWarning>
      <body
