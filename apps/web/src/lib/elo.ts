...
const CENTER: Record<string, Record<string, number>> = {
  ...
  tocfl: { "Novice 1": 400, "Novice 2": 500, "Level 1": 550, "Level 2": 850, "Level 3": 1150, "Level 4": 1500, "Level 5": 1850 },
};
 ...
 */
export function eloOf(word: Pick<VocabWord, "id" | "level" | "examMappings">): number {
