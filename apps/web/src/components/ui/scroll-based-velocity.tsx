...
export function ScrollVelocityContainer({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) {
...
function ScrollVelocityRowImpl({
  ...
  return (
    <div ref={containerRef} className={cn("w-full overflow-hidden whitespace-nowrap", className)} {...props}>
      <motion.div className="inline-flex transform-gpu items-center select-none will-change-transform" style={{ x }}>
